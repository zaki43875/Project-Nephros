...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LD3_Pin|BUZZER_Pin|RED_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LD3_Pin BUZZER_Pin RED_LED_Pin */
  GPIO_InitStruct.Pin = LD3_Pin|BUZZER_Pin|RED_LED_Pin;
